...
if (! function_exists('theme_scripts')) {
    function theme_scripts()
    {
        ...
        wp_enqueue_style('sc-style', get_template_directory_uri() . '/assets/css/style.css', array(), mt_rand());
        wp_enqueue_style('sc-responsive-style', get_template_directory_uri() . '/assets/css/responsive.css', array(), mt_rand());

        // Enqueue main script file
        wp_enqueue_script('sc-script', get_template_directory_uri() . '/assets/js/script.js', array('jquery'), mt_rand(), true);
        ...
        wp_localize_script('sc-script', 'sc', array(
            ...
            'chatbot_rest_url' => rest_url('chatbot/v1/message'),
